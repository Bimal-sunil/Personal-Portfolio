...
function ExperienceCard(props: Props) {
  ...
  return (
    <div className="flex flex-col gap-[1rem] lg:flex-row lg:justify-between">
      ...
      <p className="font-primary text-secondary text-small leading-[calc(1.5_*_var(--text-small))] w-full lg:w-[40%] lg:text-body lg:leading-[calc(1.5_*_var(--text-body))]">
        <TranslateY className="overflow-visible">{description}</TranslateY>
      </p>
    </div>
  );
}
